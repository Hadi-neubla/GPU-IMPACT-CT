...
%CAUTION: this changes the binary (indicator-like) format of the   
...
vtkwrite('CT_3D_TAVI002.vtk', 'structured_points', 'indicator', (((C(:,:,290:620)))));
