...
// !**************************************************************************************************
extern "C" __global__ void get_ghost_sp(int nx, int ny, int nz, float* rel, float* rear_ghost, float* front_ghost, float* upper_ghost, float* lower_ghost, float* west_ghost, float* east_ghost)
