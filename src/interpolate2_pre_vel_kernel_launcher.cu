...
#include "interpolate2_pre_vel_kernel.cu"
extern "C" void interpolate2_pre_vel_launcher_(int *dimension_id, int *nx_dev, int *ny_dev, int *nz_dev, int *nxIpu1, int *nyIpu1, double** phi_inter_pv_dev, double** cIpu_dev, double** inter_pv_dev)
{
...
interpolate_kernel<<< blocks,threads >>>(*dimension_id, *nx_dev, *ny_dev, *nz_dev, *nxIpu1, *nyIpu1, *phi_inter_pv_dev, *cIpu_dev, *inter_pv_dev);
return;
}
