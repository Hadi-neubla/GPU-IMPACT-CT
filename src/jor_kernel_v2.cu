...
// !**************************************************************************************************
extern "C" __global__ void jor_kernel_v2(int grid_id, int nx, int ny, int nz, int ny_cdg1, int ny_cdg2, int ny_cdg3, int nx_cdg, double omega, double* cdg1, double* cdg2, double* cdg3, double* rel, double* bb, double* rear_ghost, double* front_ghost, double* upper_ghost, double* lower_ghost, double* west_ghost, double* east_ghost)
...
////////////////handling borders : first part: slides 
               // rear ghosts
 //       if ((i >= 0) && (i <= (nx-8))) {
 //           if ((j >= 1) && (j <= (ny-9))) {
                if (k == 0) {
