...
#include "helmholtz_explicit_kernel.cu"
extern "C" void helmholtz_explicit_launcher_(int *component_id, int *nx_dev, int *ny_dev, int *nz_dev, int *nxs1, int *nxs2, int *nxs3, double *multL, double** vel1_dev, double** helm_dev, double** cS1_helm_dev, double** cS2_helm_dev, double** cS3_helm_dev)
{
...
helmholtz_kernel<<< blocks,threads >>>(*component_id, *nx_dev, *ny_dev, *nz_dev, *nxs1, *nxs2, *nxs3, *multL, *vel1_dev, *helm_dev, *cS1_helm_dev, *cS2_helm_dev, *cS3_helm_dev);
return;
}
