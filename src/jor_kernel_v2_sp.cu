...
// !**************************************************************************************************
extern "C" __global__ void jor_kernel_v2_sp(int grid_id, int nx, int ny, int nz, int ny_cdg1, int ny_cdg2, int ny_cdg3, int nx_cdg, float omega, float* cdg1, float* cdg2, float* cdg3, float* rel, float* bb, float* rear_ghost, float* front_ghost, float* upper_ghost, float* lower_ghost, float* west_ghost, float* east_ghost)
