...
#include "product_dg_relax_kernel.cu"
extern "C" void product_dg_relax_launcher_(int *grid_id, int *nx_dev_g, int *ny_dev_g, int *nz_dev_g, int *ny_cdg1_g, int *ny_cdg2_g, int* ny_cdg3_g, int *nx_cdg1_g, double** cdg1_dev2, double** cdg2_dev2, double** cdg3_dev2, double** rel_dev2, double** comp_dev2)
{
...
product_dg_relax_kernel<<< blocks,threads >>>(*grid_id, *nx_dev_g, *ny_dev_g, *nz_dev_g, *ny_cdg1_g, *ny_cdg2_g, *ny_cdg3_g, *nx_cdg1_g, *cdg1_dev2, *cdg2_dev2, *cdg3_dev2, *rel_dev2, *comp_dev2);
return;
}
