...
#include "interpolate2_vel_pre_kernel.cu"
extern "C" void interpolate2_vel_pre_launcher_(int *dimension_id, int *nx_dev, int *ny_dev, int *nz_dev, int *nxIup1, int *nyIup1, double** phi_inter_vp_dev, double** cIup_dev, double** inter_vp_dev)
{
...
interpolate_kernel2<<< blocks,threads >>>(*dimension_id, *nx_dev, *ny_dev, *nz_dev, *nxIup1, *nyIup1, *phi_inter_vp_dev, *cIup_dev, *inter_vp_dev);
return;
}
