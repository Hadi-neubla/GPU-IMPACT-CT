...
#include "divergence_kernel.cu"
extern "C" void divergence_launcher_(int *dimension_id, int *nx_dev, int *ny_dev, int *nz_dev, int *nx_div_coef1, int *ny_div_coef1, double** phi_div_dev, double** div_dev, double** cDu1_dev)
{
...
divergence_kernel<<< blocks,threads >>>(*dimension_id, *nx_dev, *ny_dev, *nz_dev, *nx_div_coef1, *ny_div_coef1,*phi_div_dev, *div_dev, *cDu1_dev);
return;
}
