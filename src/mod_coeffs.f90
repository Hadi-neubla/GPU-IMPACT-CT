...
!!pgi$l unroll = n:8
  ...
  REAL(8)   , INTENT(in)   ::  xC(bL:(Nmax+bU)) !< coefficient coordinates (onto where value are transfered)
  REAL(8)   , INTENT(in)   ::  xE(bL:(Nmax+bU)) !< coordinates of transferred value
  ...
  REAL(8)   , INTENT(out)  ::  cc(bL:bU,0:Nmax) !< coefficients
  ...
  REAL(8)                  ::  dxL, dxU ! Für Integrationskoeffizienten
  
  REAL(8)   , ALLOCATABLE  ::  cc_xi(:,:)
  ...
  REAL(8)   , INTENT(in   ) ::  deltaX        !< discrete step
  REAL(8)   , INTENT(out  ) ::  cc(1:n_coeff) !< coefficients
  ...
  INTEGER, INTENT(in)   ::  bL
  INTEGER, INTENT(in)   ::  bU
  REAL(8)   , INTENT(in)   ::  xC(bL:(Nmax+bU))
  REAL(8)   , INTENT(in)   ::  xE(bL:(Nmax+bU))
  REAL(8)   , INTENT(in)   ::  cc(bL:bU,0:Nmax)
  ...
  REAL(8)   , INTENT(in)   ::  deltaX(1:n_coeff) !< local dx
  REAL(8)   , INTENT(out)  ::  cc    (1:n_coeff) !< coefficients
  
  INTEGER               ::  i, j
  
  REAL(8)                  ::  polyn_vals    (1:n_coeff,1:n_coeff)
  REAL(8)                  ::  polyn_vals_inv(1:n_coeff,1:n_coeff)
  ...
  REAL(8)                   ::  cDu1R(-1:0,1:N1)
  REAL(8)                   ::  cDv2R(-1:0,1:N2)
  REAL(8)                   ::  cDw3R(-1:0,1:N3)
  
  REAL(8)                   ::  cGp1R( 0:1,0:N1)
  REAL(8)                   ::  cGp2R( 0:1,0:N2)
  REAL(8)                   ::  cGp3R( 0:1,0:N3)
  ...
  REAL(8)   , INTENT(in)  ::  matrix     (1:N,1:N) !< original matrix
  REAL(8)   , INTENT(out) ::  matrix_inv (1:N,1:N) !< inverted matrix
  
  REAL(8)                 ::  matrix_left(1:N,1:N)
  REAL(8)                 ::  mult1, mult2
  REAL(8)                 ::  eps
  INTEGER              ::  i, j, k
