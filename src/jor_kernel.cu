extern "C" __global__ void jor_kernel(int grid_id, int nx, int ny, int nz, int ny_cdg1, int ny_cdg2, int ny_cdg3, int nx_cdg, double omega, double* cdg1, double* cdg2, double* cdg3, double* rel, double* bb, double* comp)
...
//!//!//! this is the power 2 implementation
                  ...
                  rel[ (i + 4) + (j + 4) * nx + (k + 4) * nx * ny] =     omega *    ( bb[(i + 4) + (j + 4) * nx + (k + 4) * nx * ny]
